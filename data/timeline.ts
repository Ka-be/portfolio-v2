...
export const timelineData: TimelineItem[] = [
  ...
  },
  {
    ...
    description:
      "Intégré au service HSE, j’ai eu carte blanche pour concevoir, développer et déployer trois applications métiers en totale autonomie. De l’analyse des besoins à la mise en production, en passant par la création de maquettes et la rédaction de cahiers des charges, j’ai mis en place : une app de gestion des permis de travail, une app de gestion des accès au site et une app de gestion des déchets. Ces solutions sont aujourd’hui utilisées par plus de 800 utilisateurs sur le site industriel.",
    type: "job",
